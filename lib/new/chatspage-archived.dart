...
class ChatsPagearchived extends StatefulWidget {
  final String id;
  final String name;
  final String senderName;
  final String token;

  const ChatsPagearchived({
    Key? key,
    required this.id,
    required this.name,
  ...
  @override
  State<ChatsPagearchived> createState() => _ChatPageState();
}

class _ChatPageState extends State<ChatsPagearchived> {
  var roomId;
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              child: StreamBuilder(
                stream: firestore.collection('ArchivedMessages').snapshots(),
          ...
          // Container(
          //   color: Colors.white,
          //   child: ChatWidgetsarchived.messageField(onSubmit: (controller) async {
