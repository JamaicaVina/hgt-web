                            ...
                            builder: (context, snapshot) {
                              ...
                              var thisWeek =
                                  '${DateFormat.yMd().format(firstDayOfWeek)}_${DateFormat.yMd().format(lastDayOfWeek)}'
                                      .replaceAll('/', '_');
                              var titleWeek =
                                  '${DateFormat.yMd().format(firstDayOfWeek)} to ${DateFormat.yMd().format(lastDayOfWeek)}';
                              FirebaseFirestore.instance
                                  .collection('sales')
                                  .doc('weekly_sales')
                                  .update(
                                {
                                  thisWeek: FieldValue.arrayUnion([0])
                                },
                              );
                              // Get the array from the document data
                              List<dynamic> numbersArray =
                                  snapshot.data![thisWeek] ?? [];
                              ...
                              return Center(
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      'Total Sales from $titleWeek: $totalAmount',
